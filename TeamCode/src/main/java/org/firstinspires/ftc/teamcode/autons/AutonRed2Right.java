...
@Autonomous(name="AutonRed2Right", group="OnBot")

public class AutonRed2Right extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        AutoCommon.encoderStrafe(strafeSpeed, 10, 6050, true, false, false);

        AutoCommon.encoderTurn(.5, 1250, 10);
