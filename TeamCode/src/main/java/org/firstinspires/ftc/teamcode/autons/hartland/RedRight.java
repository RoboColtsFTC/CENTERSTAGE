...
public class RedRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (pos == 0) {
            ...
            AutoCommon.encoderStrafe(strafeSpeed, 10, -1500, false, true, false);
            ...
            AutoCommon.encoderStrafe(.5, 10, 240, false, true, false);
            ...
            AutoCommon.encoderStrafe(strafeSpeed, 10, 1550, true, true, false);
            ...
            AutoCommon.encoderStrafe(strafeSpeed, 10, 800, true, true, false);
